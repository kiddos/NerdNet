...
template <typename DType>
Tensor<DType> add(const Tensor<DType>& t1, const DType val) {
  return t1 + val;
}
...
template Tensor<float> add(const Tensor<float>& t1, const Tensor<float>& t2);
template Tensor<float> add(const Tensor<float>& t1, const float val);
template Tensor<double> add(const Tensor<double>& t1, const Tensor<double>& t2);
template Tensor<double> add(const Tensor<double>& t1, const double val);
