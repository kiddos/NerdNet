...
template Tensor<float> mul(const Tensor<float>& t1, const Tensor<float>& t2);
template Tensor<float> mul(const Tensor<float>& t1, const float val);
template Tensor<double> mul(const Tensor<double>& t1, const Tensor<double>& t2);
template Tensor<double> mul(const Tensor<double>& t1, const double val);
